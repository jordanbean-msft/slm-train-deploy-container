...
**High-level task breakdown preview**:

1. **Infrastructure Tasks** (Priority: P1)

   - Create Terraform modules for Azure ML workspace
   - Configure storage account with ML datastore
   - Provision GPU compute cluster
   - Setup Azure Container Registry
   - Implement state management and outputs
   - Setup uv for Python environment management

2. **Data Pipeline Tasks** (Priority: P1)

   - Implement JSONL validation and preprocessing
...
3. **Training Tasks** (Priority: P2)

   - Implement Phi-4 model loader from Azure AI Foundry catalog
   - Create training script with LoRA fine-tuning and quantization-aware training
   - Implement checkpointing and recovery
   - Build MLflow integration for metrics
   - Create training orchestration notebook

4. **Evaluation Tasks** (Priority: P2)

   - Implement metric computation (perplexity, accuracy)
   - Create evaluation script for Azure ML
   - Build evaluation results visualization
   - Create evaluation orchestration notebook

5. **Model Optimization Tasks** (Priority: P2)

   - Implement post-training quantization (int8, int4)
   - Create ONNX export pipeline with optimization
   - Build TorchScript compilation option
   - Implement model pruning and compression
   - Create calibration dataset generation
   - Build accuracy validation after optimization
   - Create optimization orchestration notebook

6. **Inference Tasks** (Priority: P2)

   - Implement scoring script with optimized model loading (ONNX Runtime)
   - Create lightweight inference server (FastAPI with minimal deps)
   - Build health check endpoints with minimal overhead
   - Implement efficient single-request pattern for embedded
   - Add model caching and memory management

7. **Container Tasks** (Priority: P2)
...
8. **Container Deployment Tasks** (Priority: P2)

   - Create local deployment scripts for testing
   - Implement Docker Compose configuration for local testing
   - Create embedded system deployment scripts
   - Build systemd service files for embedded Linux
   - Implement health monitoring for deployed containers
   - Create rollback and update procedures
   - Build deployment validation tests
   - Create deployment orchestration notebook

9. **Testing Tasks** (Priority: P3)
...
10. **Documentation Tasks** (Priority: P3)
